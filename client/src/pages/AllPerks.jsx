...
export default function AllPerks() {
  ...
  // Load perks when component mounts
  useEffect(() => {
    loadAllPerks();
  }, []); 

  // Auto-search when searchQuery or merchantFilter changes
  useEffect(() => {
  ...
  }, [searchQuery, merchantFilter]); // Run effect when these dependencies change
